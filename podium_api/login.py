...
# -*- coding: utf-8 -*-
import podium_api
from podium_api.asyncreq import get_json_header, make_request_custom_success
from podium_api.types.token import get_token_from_json


def make_login_post(
    username, password, success_callback=None, failure_callback=None, progress_callback=None, redirect_callback=None
):
    """
