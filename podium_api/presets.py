...
def make_preset_delete(
    token, preset_uri, success_callback=None, redirect_callback=None, failure_callback=None, progress_callback=None
):
    """
...
def presets_success_handler(req, results, data):
    ...
    """
    if data["success_callback"] is not None:
        data["success_callback"](get_paged_response_from_json(results, "presets"))
