...
from podium_api.alertmessages import (
    make_alertmessage_create, create_alertmessage_redirect_handler,
    make_alertmessages_get, make_alertmessage_get
    )
...
class TestAlertmessageCreate(unittest.TestCase):
    ...
    def test_alertmessage_create(self, mock_request):
        ...
        self.assertEqual(
            req.req_body,
            urlencode({'alertmessage[message]': 'pit now', 'alertmessage[priority]': '1'})
            )
